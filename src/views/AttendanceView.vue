...
// Bugungi sana auto-tanlanadi
const today = new Date().toISOString().slice(0, 10);
const newLesson = ref({ title: "", date: today });

// Bugungi weekday bo'yicha schedule
const todayWeekday = new Date().getDay(); // 0=Yak,1=Du,...,6=Shan
// JS: 0=Yak, 1=Du, 2=Se, 3=Chor, 4=Pay, 5=Juma, 6=Shan
// Bizda: odd=Du(1),Chor(3),Juma(5) | even=Se(2),Pay(4),Shan(6)
...
const lateCount = computed(
  () => attendances.value.filter((a) => a.status === "late").length,
);
const absentCount = computed(
  () => attendances.value.filter((a) => a.status === "absent").length,
);

// Tanlangan dars kuni uchun schedule
      ...
      <div class="flex flex-col lg:grid lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-1">
          <div class="bg-white rounded-2xl p-4 shadow-sm">
            ...
            <div
              ...
              class="bg-gray-50 rounded-xl p-3 mb-3 space-y-2"
            >
              <input
              ...
              <p v-if="newLesson.date" class="text-xs text-gray-400 px-1">
                ...
                <span class="font-medium text-gray-600">
                  {{
                    scheduleLabel[getScheduleForDate(newLesson.date)] ||
                    "Dam olish kuni"
                  }}
                </span>
                guruhi
            ...
            <div
              v-else
              class="space-y-1.5 max-h-[40vh] lg:max-h-[60vh] overflow-y-auto"
            >
              <div
              ...
              >
                ...
                >
                  ...
                  <span v-if="lesson.date === today" class="text-green-400"
                    >● Bugun</span
                  >
                </p>
              </div>
        ...
        <div class="lg:col-span-2">
          <div class="bg-white rounded-2xl p-4 shadow-sm">
            ...
            <div v-else>
              <div
                class="flex flex-wrap gap-3 justify-between items-start mb-4"
              >
                <div>
