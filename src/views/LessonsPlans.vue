...
<template>
  ...
  >
    <div
      class="mx-auto max-w-5xl overflow-hidden rounded-2xl border border-slate-800/80 bg-[#10151d] shadow-2xl shadow-black/50 animate-[fadeIn_0.4s_ease]"
    >
      <!-- Header -->
      <div
      ...
      <div v-else class="divide-y divide-slate-800/60">
        ...
        >
          ...
          >
            ...
            <span class="font-['Space_Mono',monospace] text-sm text-slate-300">
              {{ g.room || "—" }}
            </span>
            ...
            <span class="font-['Space_Mono',monospace] text-sm text-slate-400">
              {{ g.students?.length || 0 }}
            </span>
