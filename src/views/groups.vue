...
<template>
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-5xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
            ...
            <div class="flex items-center justify-between mb-4 sm:mb-6 gap-2">
                <div class="flex items-center gap-2 sm:gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-xs sm:text-sm text-gray-400">{{ groups.length }} ta guruh</p>
                    </div>
                </div>
            ...
            <!-- Mobile: panel overlaps as full-screen modal -->
            ...
            <div class="relative">
                ...
                <div :class="[
                                ...
                                <div v-for="group in groups" :key="group.id" @click="openDetail(group)" :class="[
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        ...
                                        <div class="flex shrink-0 items-center">
                                            ...
                                            <span v-if="(group.students?.length || 0) > 3"
                    ...
                    <div v-if="panel" :class="[
                        ...
                        <!-- Panel content -->
                        <div class="relative mt-auto lg:mt-0 bg-white lg:rounded-2xl shadow-lg lg:shadow-sm
                                    rounded-t-3xl max-h-[92dvh] lg:max-h-none overflow-y-auto p-5">
                            ...
                            <template v-if="panel === 'detail' && activeGroup">
                                <div class="flex items-start justify-between mb-5">
                                    <div class="min-w-0 flex-1 pr-3">
                                        <h2 class="text-lg font-semibold truncate">{{ activeGroup.name }}</h2>
                                        <p class="text-sm text-gray-400 mt-0.5 truncate">
                                            {{ activeGroup.teacher?.name || "O'qituvchi biriktirilmagan" }}
                                        </p>
                                    </div>
                                    <button @click="closePanel"
                                        class="text-gray-300 hover:text-gray-600 text-2xl leading-none shrink-0">×</button>
                                </div>
                                ...
                                <div v-if="activeGroup.students?.length > 0" class="space-y-2">
                                    <div v-for="(s, i) in activeGroup.students" :key="s.id"
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-medium truncate">{{ s.name }} {{ s.surname }}</p>
                                    ...
                                    <div class="relative">
                                        ...
                                        <div v-if="searchResults.length > 0"
                                            ...
                                            <div v-for="s in searchResults" :key="s.id" @click="addStudent(s.id)"
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <p class="text-sm font-medium truncate">{{ s.name }} {{ s.surname }}
                                                    </p>
                                                    <p class="text-xs text-gray-400">{{ s.phone }}</p>
                                                </div>
